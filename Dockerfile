...
RUN cat \
 ...
 && python -m py_compile /app/production_entrypoint_v2_4.py /app/production_backup_worker_v2_5.py /app/production_google_drive_backup_worker_v2_7.py /app/production_google_drive_backup_smoke_v2_7.py \
